...
import json
import re
class GetzbgglistSpider(scrapy.Spider):
    name = "getZbggList"
    allowed_domains = ["ggzy.yn.gov.cn"]
    start_urls = ["https://ggzy.yn.gov.cn/ynggfwpt-home-api/jyzyCenter/jyInfo/gcjs/getZbggList"]
    ...
    def parse(self, response):
        ...
        for da in data_list:
            ...
            yield scrapy.Request(
                url=f'https://ggzy.yn.gov.cn/ynggfwpt-home-api/jyzyCenter/jyInfo/gcjs/findZbggByGuid?guid={guid}',
